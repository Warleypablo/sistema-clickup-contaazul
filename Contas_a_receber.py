...
access_token = "eyJraWQiOiJUa1BRbWs0UlR3M3RuWlZXcDdEanBURFhcL2RTajNvMU5SckI0R3I3ZzFTMD0iLCJhbGciOiJSUzI1NiJ9..HvlDCjuGEGoZcocYJme_KMINU3VIxJ3MfczJF_eOamip8o38GxR34eigGyLTpLTPdxVAcSXAwX_OxPKdXIvXmewC53c0fDSLs5J9IUfK1dru6IMn2CQMdCGa7k1rkWt0ZtK1CrC3dBf8B4forE436CRuNkhc_DoFxUoldLGnMsgm3OSp7lbKulg-cOlD7OttZ1Rj_dkgbtNBWARxH4TNDOGrJt7pSJ2SDNoZLvn7KDCUlcn-V-lYJ7caLA840wDewtRhG5CB-i2MJLh3bg2cB65sQYDjUfWivoy8hEiXEVSidl94VhYAUrh5ceUL-6J5NPgWj8NrrP60IUX3e0YGuQ"  # Coloque o seu token real
...
if todos_itens:
    ...
    with conn.cursor() as cursor:
        ...
        query_delete = "DELETE FROM a_receber_turbo;"
        try:
            ...
            conn.rollback()
            print("Erro ao apagar registros antigos:", e)
